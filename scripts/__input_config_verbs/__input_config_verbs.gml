...
function __input_config_verbs()
{
    return {
        keyboard_and_mouse:
        {
			...
			teleport: [input_binding_key(ord("J"))],
			action_up: [input_binding_key(ord("O"))],
			action_down: [input_binding_key(ord("L"))],
			action_left: [input_binding_key(ord("K"))],
			action_right: [input_binding_key(vk_semicolon)],
